...
public class QMemberPrefer extends EntityPathBase<MemberPrefer> {
    ...
    public final umc.study.domain.QCategory categoryId;
    ...
    public QMemberPrefer(Class<? extends MemberPrefer> type, PathMetadata metadata, PathInits inits) {
        ...
        this.categoryId = inits.isInitialized("categoryId") ? new umc.study.domain.QCategory(forProperty("categoryId")) : null;
