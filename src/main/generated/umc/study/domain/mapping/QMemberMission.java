...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    public final umc.study.domain.QMember memberId;

    public final umc.study.domain.QMission missionId;
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.memberId = inits.isInitialized("memberId") ? new umc.study.domain.QMember(forProperty("memberId")) : null;
        this.missionId = inits.isInitialized("missionId") ? new umc.study.domain.QMission(forProperty("missionId"), inits.get("missionId")) : null;
    }
