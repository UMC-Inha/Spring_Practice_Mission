...
public class MemberMissionRestController {
    ...
    @Operation(summary = "특정 멤버의 도전 중인 미션 목록 조회 API", description = "특정 멤버의 도전 중인 미션들의 목록을 조회하는 API이며, 페이징을 포함합니다. query String 으로 page 번호를 주세요")
    @ApiResponses({
    ...
    public ApiResponse<MemberMissionResponseDTO.ChallengingMissionPreviewListDTO> getChallengingMissionList(@Valid @CheckPage @PathVariable(name="memberId") Long memberId, @RequestParam(name="page") Integer page){
